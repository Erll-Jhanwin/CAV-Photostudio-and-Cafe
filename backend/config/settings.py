...
# Gmail displays app passwords in groups of four characters. Accept that display
# format in deployment variables while preserving passwords for other providers.
_email_host_password = os.environ.get('EMAIL_HOST_PASSWORD', '')
EMAIL_HOST_PASSWORD = ''.join(_email_host_password.split()) if EMAIL_HOST.lower() == 'smtp.gmail.com' else _email_host_password
