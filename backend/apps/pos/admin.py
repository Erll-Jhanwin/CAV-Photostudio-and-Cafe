...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'staff', 'total', 'payment_status', 'order_type', 'created_at')
...
class EndOfDayReportAdmin(admin.ModelAdmin):
    list_display = ('report_date', 'staff_name', 'gross_sales', 'expected_cash', 'actual_cash', 'cash_difference', 'created_at')
